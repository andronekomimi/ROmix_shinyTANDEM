...
load.ui <- function(){
  div(
      ...
      helpText("Select either an XML result file or an .RDS file and the name of the result object to load a search."),
    div(class="row-fluid",
      div(
        div(class="well",
          h5("Load a result object from a RDS file.", style="text-align: left;"),
      ...
      div(class="span6",
        div(class="well",
          h5("Load a search from an XML result file.", style="text-align: left;"),  
          #### jasny bootstrap file selector:
          div(class="fileupload fileupload-new", 'data-provides'="fileupload",
            div(class="input-append",
              div(class="uneditable-input span5",
